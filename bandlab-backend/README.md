...
4. [Getting Started](#getting-started)
   ...
   - [Deploy the Application](#5-deploy-the-application)
   - [Running Locally](#6-running-locally)
   - [Testing the Endpoints](#7-testing-the-endpoints)
5. [Endpoints](#endpoints)
   - [Create a Post with Image Upload](#create-a-post-with-image-upload)
   - [Add a Comment to a Post](#add-a-comment-to-a-post)
   - [Delete a Comment](#delete-a-comment)
   - [List Posts with the Last Two Comments](#list-posts-with-the-last-two-comments)
...
```bash
git clone https://github.com/achmadamri/serverless.git
cd serverless
cd bandlab-backend
```
